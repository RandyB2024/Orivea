...
for (const item of selectedByReference.values()) {
  const approved = item.official?.brand === "Glantier" && item.official?.source_status === "verified_official" && item.local_status === "active" && !item.comparison?.review_required;
